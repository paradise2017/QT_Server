	...
	, m_pixPath("")
{
	...
	updateTableData();
	//windeployqt "C:/Users/Administrator/Desktop/33333/test/server/build/Debug/QQ_Client_EXE.exe"
	QPixmap pixmap(":/QtQQ_Server/logo.jpg"); 
	ui.label->setPixmap(pixmap);
	ui.label->setScaledContents(true); // 允许图标缩放以适应标签大小
	//定时刷新数据
